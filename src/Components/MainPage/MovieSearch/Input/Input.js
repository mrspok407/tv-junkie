  ...
  render() {
    return (
      <>
        ...
        <div ref={this.mediaTypeRef} className="search__media-type">
          <button
            type="button"
            onClick={() =>
