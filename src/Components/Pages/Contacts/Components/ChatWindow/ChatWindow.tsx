...
const ChatWindow: React.FC = () => {
  ...
  const firstUnreadMessage = useMemo(() => messagesData?.find((message) => message.key === unreadMessagesAuth[0]), [unreadMsgsListenerChatKey, rerenderUnreadMessagesStart, chatWindowLoading, markAsRead])
