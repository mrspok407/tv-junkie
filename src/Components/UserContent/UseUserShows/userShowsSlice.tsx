...
export const fetchUserShows =
  (uid: string, firebase: FirebaseInterface): AppThunk => async (dispatch) => {
    try {
...
export const handleNewShow =
  (showData: UserShowsInterface, firebase: FirebaseInterface): AppThunk => async (dispatch) => {
...
export const handleChangeShow =
  (showData: UserShowsInterface, firebase: FirebaseInterface): AppThunk => async (dispatch, getState) => {
